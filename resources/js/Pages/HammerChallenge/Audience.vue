  ...
  >
    ...
    <header class="relative z-10 w-full max-w-4xl mx-auto px-4 pt-6 pb-4 flex items-center justify-between gap-2">
      <Link href="/" class="flex items-center gap-2.5 sm:gap-3 group">
        <div class="w-9 h-9 rounded-xl overflow-hidden border border-amber-500/40 shadow-lg shadow-red-950/40 group-hover:scale-105 transition bg-red-600 flex items-center justify-center p-1">
          <img 
      ...
      <div class="relative rounded-3xl bg-zinc-950/90 border border-amber-500/35 p-6 sm:p-8 shadow-2xl shadow-black/95 backdrop-blur-xl transition-all duration-300">
        ...
        <div v-if="currentStep === 1" class="space-y-6 animate-in fade-in duration-200">
          ...
          <div class="flex items-center justify-center -space-x-3 rtl:space-x-reverse pt-1">
            <!-- Official Veneno Emblem Circle with Gold Border -->
            <div class="relative z-10 w-16 h-16 rounded-full overflow-hidden border-2 border-amber-400/90 shadow-xl shadow-red-950/70 flex items-center justify-center bg-[#ef4444] p-2 ring-2 ring-black/60">
              <img 
                src="/images/veneno-emblem.png" 
            ...
            <!-- Google Official Logo Circle with Gold Border -->
            <div class="relative z-20 w-16 h-16 rounded-full bg-white border-2 border-amber-400/90 shadow-xl shadow-black/70 flex items-center justify-center p-3 ring-2 ring-black/60">
