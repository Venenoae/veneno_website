...
<template>
  ...
  <div class="relative min-h-screen overflow-hidden bg-[#070709] px-4 py-10 text-zinc-100">
    ...
    <main class="mx-auto flex min-h-[80vh] max-w-2xl items-center justify-center">
      ...
      <section v-else class="relative w-full overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-b from-red-950/70 via-zinc-950 to-black p-7 text-center shadow-2xl shadow-black/70 sm:p-12">
        ...
        <CheckCircle2 class="mx-auto h-16 w-16 text-emerald-400" />
        <p class="mt-6 text-xs font-mono uppercase tracking-[0.25em] text-red-300">Registration confirmed</p>
        ...
        <div class="mt-8 rounded-2xl border border-amber-500/50 bg-gradient-to-b from-amber-500/15 to-zinc-950 p-5 shadow-lg shadow-amber-950/20"><p class="text-xs uppercase tracking-[0.2em] text-amber-300">Registration number</p><p class="mt-3 text-4xl font-black tracking-[0.18em] text-white sm:text-5xl">{{ registration.registration_number }}</p><p class="mt-2 text-[10px] font-mono uppercase tracking-widest text-zinc-500">Keep this number for event check-in</p></div>
